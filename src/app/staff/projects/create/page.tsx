...
const CreateProject = () => {
        return (
                <div className='w-full h-full overflow-y-auto overflow-x-hidden p-2 text-sm'>
                        < h2 className='text-[17px] font-medium  text-[rgba(0,0,0,0.7)] my-2' >Publish a Project</h2 >
                        <p className='text-[rgba(67,67,67,0.43)] my-2 capitalize'>Make your Project discoverable by the whole world</p>
                        <div className="my-10 grid grid-cols-2 gap-5">
                                <PhotoInput />
                                <div className="w-[50%] md:w-full">
                                        <input type="text" placeholder='Project Name' className=' w-full  my-2 px-3 py-2 text-black placeholder:text-black bg-[rgba(67,67,67,0.03)]  rounded-md border-[2px] border-[rgba(67,67,67,0.09)]' />
                                        <input type="text" placeholder='Project Website Link' className=' w-full  my-2 px-3 py-2 text-black placeholder:text-black bg-[rgba(67,67,67,0.03)]  rounded-md border-[2px] border-[rgba(67,67,67,0.09)]' />
