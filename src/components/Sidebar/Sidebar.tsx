        ...
        return (
                <div className='hidden md:block bg-[#D9D9D975] border-2 border-[#43434305] p-1 rounded-md h-full  w-fit md:w-[25vw] lg:w-[20vw] text-[#00000075] text-sm'>
                        ...
                        <div className='font-medium'>
                                <Link href={"/staff/"}
                                        className={isActiveLink("/staff/") ? 'flex flex-row gap-5 items-center p-3 rounded-lg bg-[rgba(42,10,82,0.1)] text-[rgba(42,10,82,0.8)] my-2' : 'flex flex-row gap-5 items-center p-3 rounded-lg hover:bg-[rgba(42,10,82,0.1)] hover:text-[rgba(42,10,82,0.8)] my-2'}>
                                ...
                                <Link href={"/staff/report-cards"}
                                        className={isActiveLink("/staff/report-cards") ? 'flex flex-row gap-5 items-center p-3 rounded-lg bg-[rgba(42,10,82,0.1)] text-[rgba(42,10,82,0.8)] my-2' : 'flex flex-row gap-5 items-center p-3 rounded-lg hover:bg-[rgba(42,10,82,0.1)] hover:text-[rgba(42,10,82,0.8)] my-2'}>
                                ...
                                <Link href={"/staff/innovations"}
                                        className={isActiveLink("/staff/innovations") ? 'flex flex-row gap-5 items-center p-3 rounded-lg bg-[rgba(42,10,82,0.1)] text-[rgba(42,10,82,0.8)] my-2' : 'flex flex-row gap-5 items-center p-3 rounded-lg hover:bg-[rgba(42,10,82,0.1)] hover:text-[rgba(42,10,82,0.8)] my-2'}>
                                ...
                                <Link href={"/staff/news/create"}
                                        className={isActiveLink("/staff/news/create") ? 'flex flex-row gap-5 items-center p-3 rounded-lg bg-[rgba(42,10,82,0.1)] text-[#2a0a52cc] my-2' : 'flex flex-row gap-5 items-center p-3 rounded-lg hover:bg-[rgba(42,10,82,0.1)] hover:text-[rgba(42,10,82,0.8)] my-2'}>
                                        ...
                                        <p className='hidden md:block transition-all duration-200'>{"Compose News"}</p>
                                </Link>
                                <Link href={"/staff/parents-students"}
                                        className={isActiveLink("/staff/parents-students") ? 'flex flex-row gap-5 items-center p-3 rounded-lg bg-[rgba(42,10,82,0.1)] text-[rgba(42,10,82,0.8)] my-2' : 'flex flex-row gap-5 items-center p-3 rounded-lg hover:bg-[rgba(42,10,82,0.1)] hover:text-[rgba(42,10,82,0.8)] my-2'}>
                                        <svg width="18" height="19" viewBox="0 0 18 19" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                        d="M15 11L14.999 14H18V16H14.999L15 19H13L12.999 16H10V14H12.999L13 11H15ZM8 14V16H0V14H8ZM18 7V9H0V7H18ZM18 0V2H0V0H18Z"
                                                />
                                ...
                                <Link href={"/staff/customizations"}
                                        className={isActiveLink("/staff/customizations") ? 'flex flex-row gap-5 items-center p-3 rounded-lg bg-[rgba(42,10,82,0.1)] text-[rgba(42,10,82,0.8)] my-2' : 'flex flex-row gap-5 items-center p-3 rounded-lg hover:bg-[rgba(42,10,82,0.1)] hover:text-[rgba(42,10,82,0.8)] my-2'}>
                                ...
                                <Link href={"/staff/profile"}
                                        className={isActiveLink("/staff/profile") ? 'flex flex-row gap-5 items-center p-3 rounded-lg bg-[rgba(42,10,82,0.1)] text-[rgba(42,10,82,0.8)] my-2' : 'flex flex-row gap-5 items-center p-3 rounded-lg hover:bg-[rgba(42,10,82,0.1)] hover:text-[rgba(42,10,82,0.8)] my-2 hover:fill-[]'}>
