...
const Navbar: React.FC<Props> = ({ logginPage }) => {
        ...
        return (
                <div className='flex flex-row justify-between items-center mx-3 my-1.5 bg-[#F1F2F7] border-2 border-[#43434305] p-1 rounded-md  '>
                                ...
                                <div className='bg-[#D9D9D975] border-2 border-[#43434305] p-1 rounded-md h-full  w-[70vw] sm:w-[50vw]  text-[#00000075] text-sm'>
                                        ...
                                        <div className='font-medium' onClick={()=>setMobileNav(false)}>
                                                ...
                                                <Link href={"/staff/news/create"}
                                                        className={isActiveLink("/staff/news/create") ? 'flex flex-row gap-5 items-center p-3 rounded-lg bg-[rgba(42,10,82,0.1)] text-[rgba(42,10,82,0.8)] my-2' : 'flex flex-row gap-5 items-center p-3 rounded-lg hover:bg-[rgba(42,10,82,0.1)] hover:text-[rgba(42,10,82,0.8)] my-2'}>
